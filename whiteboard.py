...
# Approach:
# We are given a starting shelf and an ending shelf
# We want to continue to make 3 step jumps while we can (without overshooting the end step)
# Once we can't make any more 3 step jumps, continue to make 1 step jumps until we are at our end shelf
# Each time we make a jump, keep track of the number of jumps
